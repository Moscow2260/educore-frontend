  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.user.role !== 'Lecturer') {
        updateToast(toastId, 'error', 'Access denied. Lecturer privileges required.');
        setLoading(false);
        return; // Stay on the same page
      }

      updateToast(toastId, 'success', 'Login successful! Redirecting to lecturer portal...');
      setTimeout(() => {
        window.location.href = '/lecturer-portal';
      }, 1000);
    } catch (error) {
            ...
            <Card className="auth-card shadow">
              <Card.Body className="p-5">
                <div className="text-center mb-4">
                  ...
                  <p className="text-muted">Access the lecturer portal</p>
                </div>
